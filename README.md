...
本仓库公开 QASMA v3.2 的整体架构骨架和可视化工作台，不包含搜索后端的具体 Python 实现、可执行的真实模型调用配置、内部研究文档或真实实验结果。

![QASMA v3.2 系统架构](assets/qasma-system-architecture.png)

## 架构定位

QASMA v3.2 由四类核心能力组成：
...
然后访问终端输出的本地地址。也可以把仓库作为普通静态站点部署。所有演示数值均不构成研究结果、性能声明或 SOTA 声明。
